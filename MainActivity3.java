...
public class MainActivity3 extends AppCompatActivity {
    ...
    private static final  int cardSevenID = R.id.card7;
    private static final  int cardEightID = R.id.card8;
    private static final  int cardNineID = R.id.card9;
    private static final  int cardTenID = R.id.card10;
    ...
    private static final  int cardOneID7 =R.id.doublecard7;
    private static final  int cardOneID8 =R.id.doublecard8;
    private static final  int cardOneID9 =R.id.doublecard9;
    private static final  int cardOneID10 =R.id.doublecard10;
    ...
    int[] getCardID = {
            ...
            cardSevenID, cardOneID7,
            cardEightID, cardOneID8,
            cardNineID, cardOneID9,
            cardTenID, cardOneID10,
    };
    ...
    int[] faces = {
            ...
            R.drawable.pic8,  R.drawable.pic8,
            R.drawable.pic9, R.drawable.pic9,
            R.drawable.pic10,  R.drawable.pic10,
    };
